(function ($) {
  ...
  function toggleDarkTheme() {
    ...
    if (isDarkTheme) {
      ...
      // home1bgimg.style.backgroundImage = "url('assets/bg.jpg')";
      // home2bgimg.style.backgroundImage = "url('assets/bg.jpg')";
    }
  }
...
document.getElementById('copyBtn').addEventListener('click', function() {
  navigator.clipboard.writeText("8503875941")
  .then(() => {
...
// Copy to clip email
document.getElementById('copyBtnEmail').addEventListener('click', function() {
  navigator.clipboard.writeText("kumawat8503@gmail.com")
  .then(() => {
      // Display the Bootstrap toast notification
      let toastElement = document.getElementById('copyToastEmail');
      let toast = new bootstrap.Toast(toastElement);
      toast.show();
  })
  .catch(err => {
